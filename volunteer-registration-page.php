        ...
        <div class="row">
            <div class="col-lg-12 align-self-center">
                <div class="section-heading">
                    <h6>Register as colunteer for the event</h6>
            ...
            <div class="col-lg-12">
                <div class="contact-us-content">
                    <form id="volunteer-registration-form" method="post">
                        <?php wp_nonce_field('volunteer_registration', 'volunteer_registration_nonce'); ?>
                        <input type="hidden" name="action" value="volunteer_registration">
                        <div class="row">
                            <div class="col-lg-12">
                                <fieldset>
                                    <a>Username</a>
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    ...
                                    <button type="submit" id="volunteer-register-submit"
...
<style>
    ...
    #volunteer-registration-form fieldset a {
        color: white;
    }
